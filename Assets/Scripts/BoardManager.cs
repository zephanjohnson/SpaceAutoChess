...
public class BoardManager : MonoBehaviour
{
    ...
    //        if (!instantiatedShip)
    //        {
    //            occupiedSlot.Assign(col, coordinateRange, true);
    //            instantiatedShip = true;
    //        }
    //        else
    //        {
    //            occupiedSlot.Assign(col, coordinateRange);
    //        }
    //    }
    //}

    //public void RemoveFromBoardSlot(Collectible col)
    //{
    //    //foreach (var slot in _boardSlots)
    //    //{
    //    //    if (slot.Ship?.Collectible == col)
    //    //    {
    //    //        foreach (var coordinate in slot.Ship.ShipRangeCoordinates)
    //    //        {
    //    //            var occupiedSlot = _boardSlots[(int)coordinate.x, (int)coordinate.y];
